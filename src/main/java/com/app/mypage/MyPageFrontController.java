...
import com.app.mypage.controller.MyPageMyTreeDeleteController;
...
public class MyPageFrontController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        } else if (target.equals("mypage-mytree-delete-ok")) {
        	result = new MyPageMyTreeDeleteController().execute(req, resp);
