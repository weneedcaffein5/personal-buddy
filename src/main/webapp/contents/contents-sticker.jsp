...
<div class="folder-wrapper">
	<div class="folder">
		<div class="folder-item-sticker">
			<img src="../assets/images/contents/sticker/deer-sticker.png" alt="field-bg">
			<span>토끼</span>
		...
		<div class="folder-item-sticker">
			<img src="../assets/images/contents/sticker/fox-sticker.png" alt="beach-bg">
			<span>버디</span>
			<div class="item-button-group">
				<button>변경</button>
				<button>제거</button>
